...
void TTACommThread::executeRunTest1(int aNumTx)
{
   Prn::print(Prn::Show4, "TTACommThread::executeRunTest1 BEGIN");
   ...
   try
   {
      ...
      for (int i = 0; i < aNumTx; i++)
      {
         ...
         // Loop delay.
         mNotify.waitForTimer(2000);
      }
   }
   catch(int aException)
   {
      mLoopExitCode = cLoopExitAborted;
      Prn::print(0, "EXCEPTION TTACommThread::executeRunTest1 %d %s", aException, mNotify.mException);
   }
   ...
   Prn::print(Prn::Show4, "TTACommThread::executeRunTest1 END");
}
...
void TTACommThread::doRunCmd_Send()
{
   // Guard.
